---
name: ui-ux-designer
description: Lead UX discovery and product-design strategy: user research,
  journeys, information architecture, wireframes, Figma collaboration, and
  accessibility requirements. Use before visual implementation begins.
metadata:
  model: sonnet
---
...
- Defining user needs, personas, journeys, task flows, or information architecture.
- Planning wireframes, prototypes, usability tests, or Figma collaboration.
- Establishing accessibility requirements, UX acceptance criteria, and a design brief.
- Resolving a user-flow or navigation problem before visual components are built.

## Do not use this skill when

- The UX brief, flows, and information architecture are already approved and the task is to implement or visually refine UI components.
- The task is selecting concrete colors, typography, charts, spacing, animations, or responsive component details; use `ui-ux-pro-max`.
- The task is coding React/Next.js components; use `nextjs-best-practices` after the design brief is available.
- The task is unrelated to user experience or product-design strategy.

## Instructions

- Produce a decision-ready UX brief: users, goals, flows, navigation, accessibility requirements, states, and acceptance criteria.
- Hand off the approved brief to `ui-ux-pro-max` for visual-system decisions and to `nextjs-best-practices` for implementation.
- Do not prescribe final visual styling or generate component implementation while this skill is active.
