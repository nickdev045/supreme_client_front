---
name: ui-ux-pro-max
description: "Apply an approved UX brief to visual UI implementation and quality review. Use for concrete components, color, typography, spacing, responsiveness, interaction, animation, charts, and accessibility checks—not UX discovery, research, wireframes, or information architecture."
---
...
Use this Skill only after an approved UX brief, user flow, or information architecture exists. Apply it to **visual UI implementation and quality review**: creating/refactoring pages and components, choosing color/typography/spacing/layout systems, implementing navigation/animation/responsive behavior, designing charts, or reviewing visual accessibility and consistency.

Do not use this Skill for user research, personas, journey maps, information architecture, navigation discovery, wireframes, prototype planning, usability-test planning, or Figma discovery work; use `ui-ux-designer` for those tasks first.
